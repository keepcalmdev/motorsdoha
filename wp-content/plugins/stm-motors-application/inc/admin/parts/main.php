...
if ( isset( $_POST['global_save'] ) ) {
    ...
    update_option( 'filter_params', ( !empty( $_POST['filter-opt'] ) ) ? $_POST['filter-opt'] : '' );
    update_option( 'add_car_step_one', ( !empty( $_POST['step_one-opt'] ) ) ? $_POST['step_one-opt'] : '' );
    update_option( 'add_car_step_two', ( !empty( $_POST['step_two-opt'] ) ) ? $_POST['step_two-opt'] : '' );
    update_option( 'add_car_step_three', ( !empty( $_POST['step_three-opt'] ) ) ? $_POST['step_three-opt'] : '' );
