            ...
            <div class="tab-content" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade" id="v-pills-grid" role="tabpanel"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="hidden" name="grid_one_text" value="<?php echo $go_one; ?>"/>
                            <input type="hidden" name="grid_two_text" value="<?php echo $go_two; ?>"/>
                            <input type="hidden" name="grid_three_text" value="<?php echo $go_three; ?>"/>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="v-pills-list" role="tabpanel" aria-labelledby="v-pills-list-tab">
                    ...
                    <div class="row">
                        <div class="col-md-9"></div>
                        <div class="col-md-3">
                            <input type="hidden" name="list_info_one" value="<?php echo $listInfoOne; ?>"/>
                            <input type="hidden" name="list_info_two" value="<?php echo $listInfoTwo; ?>"/>
                            <input type="hidden" name="list_info_three" value="<?php echo $listInfoThree; ?>"/>
                            <input type="hidden" name="list_info_four" value="<?php echo $listInfoFour; ?>"/>
                ...
                <div class="tab-pane fade" id="v-pills-inv-details" role="tabpanel"
                    ...
                    <div class="row">
                        <div class="col-md-9"></div>
                        <div class="col-md-3">
                            <input type="hidden" name="listing_details_title" value="<?php echo $ldTitle; ?>"/>
                            <input type="hidden" name="listing_details_subtitle"
                                   value="<?php echo $ldSubTitle; ?>"/>
                            <input type="hidden" name="listing_details_info" value="<?php echo $ldInfo; ?>"/>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    (function ($) {
        $(document).ready(function () {
            ...
            $('#go_one').val( <?php echo json_encode( explode( ',', $go_one ) ); ?>).trigger("change");
            $('#go_two').val( <?php echo json_encode( explode( ',', $go_two ) ); ?>).trigger("change");
            $('#go_three').val(<?php echo json_encode( explode( ',', $go_three ) ); ?>).trigger("change");
