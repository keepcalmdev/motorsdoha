...
echo '<div class="bsaProItemInner__thumbBg" style="background-color:'.$background_color.'"></div>';
...
echo '<h3 class="bsaProItemInner__title" style="color:'.$title_color.';background:'.$extra_color_1.';border-color:'.$extra_color_1.';">'.$ad['title'].'</h3>'; // -- ITEM -- TITLE
