...
echo '<div class="bsaProItemInner__copy" style="background:'.$background_color.'">'; // -- START -- ITEM COPY
...
echo '<div class="bsaProItemInner__desc" style="color:'.$description_color.'">'.$ad['description'].'</div>'; // -- ITEM -- DESCRIPTION
