...
echo '<div class="bsaProItemInner__copy z-depth-2" style="background:'.$background_color.'">'; // -- START -- ITEM COPY

echo '<div class="bsaProItemInner__copyInner" style="background:'.$background_color.'">'; // -- START -- ITEM COPY INNER
