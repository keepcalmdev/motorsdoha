...
// Require files
if ( file_exists(ABSPATH . '/wp-content/plugins/bsa-plugin-pro-scripteo/lib/BSA_PRO_Model.php') && file_exists(ABSPATH . '/wp-content/plugins/bsa-pro-ap-scripteo/lib/functions.php') ) {
	require_once ABSPATH . '/wp-content/plugins/bsa-plugin-pro-scripteo/lib/BSA_PRO_Model.php';
...
class BuySellAdsProAffiliate
{
	...
	function onActivate() {
		...
		if ( floatval(get_option('bsa_pro_plugin_version')) < 2.9 || !is_plugin_active( 'bsa-plugin-pro-scripteo/bsa-pro.php' ) ) {
			deactivate_plugins( plugin_basename( __FILE__ ) );
			wp_die( 'This Add-on requires <strong>Ads Pro 2.9.0</strong> or higher version. Download it <strong><a href="http://tinyurl.com/Ads-Pro-WordPress">here</a></strong>.' );
		}
