					...
					<ul id="inside-hide-countries" data-wp-lists="list:countries" class="countrieschecklist form-no-clear">
						<li class="bsaProSpecificDevice">
							<label class="selectit">
								...
								<img src="<?php echo plugins_url('/bsa-plugin-pro-scripteo/frontend/img/icon-mobile.png'); ?>"/><br>
								Mobile
							</label>
						</li>
						<li class="bsaProSpecificDevice">
							<label class="selectit">
								...
								<img src="<?php echo plugins_url('/bsa-plugin-pro-scripteo/frontend/img/icon-tablet.png'); ?>"/><br>
								Tablet
							</label>
						</li>
						<li class="bsaProSpecificDevice">
							<label class="selectit">
								...
								<img src="<?php echo plugins_url('/bsa-plugin-pro-scripteo/frontend/img/icon-desktop.png'); ?>"/><br>
								Desktop
							</label>
						</li>
					</ul>
