...
if( !class_exists('TRP_LICENSE_PAGE') ) {
    class TRP_LICENSE_PAGE
    {
        ...
        public function license_page()
        {
            ...
            $action = 'options.php';
            ob_start();
            require TRP_NBL_PLUGIN_DIR . 'partials/license-settings-page.php';
            echo ob_get_clean();
        }
    ...
    public function activate_license() {
		...
		if( isset( $_POST['edd_license_activate'] ) ) {
            ...
            $api_params = array(
                    ...
                    'license'    => $license,
                    'item_name'  => urlencode( TRP_NBL_ITEM_NAME ), // the name of our product in EDD
                    'url'        => home_url()
                   );

            // Call the custom API.
            $response = wp_remote_post( TRP_NBL_STORE_URL, array( 'timeout' => 15, 'sslverify' => false, 'body' => $api_params ) );
            ...
            if ( is_wp_error( $response ) || 200 !== wp_remote_retrieve_response_code( $response ) ) {
                        ...
                        case 'item_name_mismatch' :
                                                        ...
                                                        $message = sprintf( __( 'This appears to be an invalid license key for %s.' ), TRP_NBL_ITEM_NAME );
                                                        break;
