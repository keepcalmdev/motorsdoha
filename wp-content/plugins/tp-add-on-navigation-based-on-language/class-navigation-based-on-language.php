...
class TRP_Navigation_Based_on_Language{
    ...
    public function __construct() {
        ...
        require_once(  TRP_NBL_PLUGIN_DIR . 'includes/class-plugin-updater.php' );
        $this->plugin_updater = new TRP_NBL_Plugin_Updater();
        ...
        $this->loader->add_action( 'admin_enqueue_scripts', $this, 'enqueue_navigation_script' );
