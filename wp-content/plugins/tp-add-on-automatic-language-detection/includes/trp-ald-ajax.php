...
class TRP_ALD_Ajax{
    ...
    /**
     * TRP_ALD_Ajax constructor. Echos the preferred language.
     *
     */
    public function __construct(){
	    ...
	    $trp_determine_language = new TRP_ALD_Determine_Language();

	    // sanitize input
	    $detection_method = $this->sanitize_string( $_POST['detection_method'] );
	    $published_languages = $this->sanitize_array( $_POST['publish_languages'] );
	    $iso_codes = $this->sanitize_array( $_POST['iso_codes'] );
