...
$wpa_these = array("http:","https:","/","www.","wp-content",$wpa_domain);
...
if(file_exists(wpaacDOC_ROOT . $wpa_domain . ".txt"))
{
...
<?php
$cdn_details = file_get_contents(wpaacDOC_ROOT . $wpa_domain . ".txt");
