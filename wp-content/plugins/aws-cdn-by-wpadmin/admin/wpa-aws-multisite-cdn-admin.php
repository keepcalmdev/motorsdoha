...
{
$wpaoldfilename = wpaacDOCOLD_ROOT . $wpasite->domain . ".txt";
$wpafilename = wpaacDOC_ROOT . $wpasite->domain . ".txt";	
...
echo "<div style='cursor:pointer;' class='wpasitelist btn btn-default' data-code=\"".strip_tags($awsid[0][0])."\" data-target=\"".strip_tags($awsdomain[0][0])."\" data-id=\"".$wpasite->blog_id."\"><b>".$wpasite->domain. "</b><br>" . strip_tags($awsdomain[0][0]) .  "</div>&nbsp;";
}
}
?>
</ul></p>
