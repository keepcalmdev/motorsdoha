...
<br>
<?php	global $pagenow; 
if(($pagenow == "admin.php" && $_GET['page'] == 'wpa-aws-cloudfront') || $pagenow == "plugins.php" )
{
?>
<div class="notice notice-success is-dismissible" style='background:#efefef'>
<h4><b>Amazon AWS CDN</b> plugin now supports WordPress Multisite Setups.</h4>
<h5>If you found this plugin useful, <a style='background:#ff6600;color:#fff;padding: 5px 7px;' href='https://wordpress.org/support/plugin/aws-cdn-by-wpadmin/reviews/#new-post' target=_BLANK>please write a review</a> and/or <a style='background:#ff6600;color:#fff;padding: 5px 7px;' href='https://PayPal.Me/GraySquareSolutions' target=_BLANK>kindly buy me a coffee</a></h5>
<p>If you made a donation, <a href='/wp-admin/admin.php?page=aws-cdn-registration'>Click Here to remove this message.</a></p>
</div>
<?php
}
}
...
{
$wpa_replace .= "/$wpa_cdn_domain";
}
$wpa_ignore_cdn_link = str_replace($wpa_replace,$wpa_awscf_link,$wpaac_cdnlist);
