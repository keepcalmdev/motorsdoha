            ...
            if ( !empty( $select_strings ) ) {
                ...
                foreach ( $select_strings as $select_string ) {
                    ...
                    if ( $select_string == 'price' ) {
                        ...
                        $number_string .= sprintf( _x( '%s', 'Select Text', 'motors' ), stm_get_name_by_slug( $select_string ) );
                        ...
                        if ( !empty( $taxonomy_info['numeric'] ) and $taxonomy_info['numeric'] ) {
                            ...
                            if ( !empty( $numbers ) ) {
                                ...
                                $output .= '<option value="">' . sprintf( _x( '%s', 'Option text', 'motors' ), stm_get_name_by_slug( $select_string ) ) . '</option>';
                            ...
                            if ( $select_string == 'location' ) {
                                ...
                                $select_main .= sprintf( _x( '%s', 'Option select text', 'motors' ), stm_get_name_by_slug( $select_string ) );
    ...
    function stm_get_filter_badges()
    {
        ...
        foreach ( $attributes as $attribute => $terms ) {
            ...
            if ( !empty( $options['number_field_affix'] ) ) {
                $affix = sprintf( _x( '%s', 'Affix text', 'motors' ), $options['number_field_affix'] );
            }
