...
function stm_load_theme_ss()
{
	...
	wp_enqueue_style( 'stm-theme-style', $directoryStylesheet . '/style1.css', null, STM_THEME_VERSION, 'all' );
    ...
    wp_enqueue_script( 'stm-jquery-ui-core', get_theme_file_uri( '/assets/js/jquery-ui.min.js' ), $jquery, STM_THEME_VERSION, true );
