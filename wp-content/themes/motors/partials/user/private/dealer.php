				...
				<div class="stm-user-private-sidebar">
					...
					<div class="clearfix stm-user-top">
						...
						<div class="stm-user-profile-information">
							<a href="<?php echo esc_url(add_query_arg(array('page' => 'settings'), stm_get_author_link(''))); ?>" class="title heading-font"><?php echo esc_attr(stm_display_user_name($user->ID)); ?></a>
