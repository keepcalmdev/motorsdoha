                    ...
                    if(get_theme_mod('dealer_payments_for_featured_listing', false)) :?>
                        <div>
                            ...
                            <?php else :
                                ...
                                ?>
                                <span class="<?php echo esc_attr($featuredClass); ?>"><?php printf(_x('%s', 'Featured Text', 'motors'), $featuredText); ?><i class="fa fa-star" aria-hidden="true"></i></span>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
					<a href="<?php //echo esc_url(stm_get_add_page_url('edit', get_the_ID())); ?><?php echo get_permalink(1735).'?edit_car=1&item_id='.get_the_ID(); ?>">
