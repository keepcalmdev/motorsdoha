					...
					<div class="pull-right xs-pull-left">
						<ul class="top-bar-info clearfix">
							<?php if( $top_bar_working_hours ){ ?>
								<li <?php if(!$top_bar_working_hours_mobile){ ?>class="hidden-info"<?php } ?>><i class="fa fa-clock-o"></i> <?php echo esc_html( $top_bar_working_hours ); ?></li>
							<?php } ?>
							<?php if( $top_bar_address ){ ?>
								...
								<li <?php if(!$top_bar_address_mobile){ ?>class="hidden-info"<?php } ?>>
									<span class="fancy-iframe" data-url="<?php echo esc_attr($header_address_url); ?>">
										<i class="fa fa-map-marker"></i> <?php echo esc_html( $top_bar_address ); ?>
									</span>
								</li>
							<?php } ?>
							<?php if( $top_bar_phone ){ ?>
								<li <?php if(!$top_bar_phone_mobile){ ?>class="hidden-info"<?php } ?>><i class="fa fa-phone"></i> <?php echo esc_html( $top_bar_phone ); ?></li>
							<?php } ?>
						</ul>
					</div>
				<?php endif; ?>
