	...
	<div class="container">
		<div class="clearfix">
			...
			<div class="header-top-info" style="margin-top: <?php echo get_theme_mod( 'menu_top_margin', '0' ); ?>px;">
				<div class="clearfix">
					<!-- <div class="header-listing"><div class="listing-right-actions clearfix"><a href="/add-a-car-page/" class="listing_add_cart heading-font"><div><i class="stm-service-icon-listing_car_plus"></i> Add your item</div></a></div></div> -->
					<!--Socials-->
						...
						<div class="pull-right">
							<div class="header-secondary-phone">
								<div class="phone">
									...
									<?php endif; ?>
									<span class="phone-number heading-font"><a href="tel:<?php printf(esc_attr__( '%s', 'motors' ), $header_secondary_phone_1 ); ?>"><?php printf(esc_html__( '%s', 'motors' ), $header_secondary_phone_1 ); ?></a></span>
								</div>
								<div class="phone">
