...
function stm_admin_patch_price()
{
    ...
    check_ajax_referer('stm_admin_patch_price', 'security');
...
function stm_admin_patch_location()
{
    ...
    check_ajax_referer('stm_admin_patch_location', 'security');
...
function stm_admin_patch_cat_image()
{
    ...
    check_ajax_referer('stm_admin_patch_cat_image', 'security');
