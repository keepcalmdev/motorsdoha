						...
						<?php foreach( ${'pt_' . $i . '_periods'} as ${'pt_' . $i . '_periods_item'} ) : ?>
							<?php if( ! in_array( ${'pt_' . $i . '_periods_item'}['pt_'. $i .'_periods_period'], $pricing_periods ) ) : ?>
								<?php
                                    ...
                                    ?>
								<li class="stm-pricing__filter <?php echo ( ( $pricing_periods[0] == $pp ) ? 'stm-pricing__filter_active' : '' ); ?>"><a data-period-filter="<?php echo esc_attr( $pp ); ?>" href="#"><?php echo esc_html( $pp ); ?></a></li>
							<?php endif; ?>
						<?php endforeach; ?>
					<?php endfor; ?>
				</ul>
